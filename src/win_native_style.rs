    ...
    fn default() -> Self {
        ...
        if dark {
            Self {
                ...
                bg: rgb(21, 26, 34),
                nav_bg: rgb(25, 31, 40),
                nav_sel_fill: rgb(35, 47, 66),
                surface: rgb(29, 35, 45),
                surface2: rgb(38, 45, 57),
                stroke: rgb(48, 58, 72),
                text: rgb(242, 246, 252),
                text_muted: rgb(154, 166, 184),
                item_hover: rgb(36, 44, 56),
                item_selected: mix(accent, rgb(29, 35, 45), 0.78),
                control_bg: rgb(28, 34, 44),
                control_stroke: rgb(57, 69, 86),
                button_bg: rgb(37, 44, 56),
                button_hover: rgb(49, 58, 72),
                button_pressed: rgb(32, 39, 50),
            ...
            Self {
                ...
                accent_pressed,
                bg: rgb(243, 246, 250),
                nav_bg: rgb(234, 239, 247),
                nav_sel_fill: rgb(255, 255, 255),
                surface: rgb(255, 255, 255),
                surface2: rgb(244, 247, 251),
                stroke: rgb(218, 225, 235),
                text: rgb(24, 34, 53),
                text_muted: rgb(100, 114, 137),
                item_hover: rgb(239, 244, 250),
                item_selected: mix(accent, rgb(255, 255, 255), 0.86),
                control_bg: rgb(255, 255, 255),
                control_stroke: rgb(194, 204, 218),
                button_bg: rgb(255, 255, 255),
                button_hover: rgb(238, 243, 249),
                button_pressed: rgb(228, 235, 244),
                close_hover: rgb(196, 43, 28),
            }
        }
    }
