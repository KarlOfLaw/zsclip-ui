...
#[allow(dead_code)]
pub(crate) fn macos_native_group_type_filter_enabled() -> bool {
    macos_native_settings_json_snapshot()
...
pub(crate) fn macos_native_host_projected_clip_items_for_category_group(
    ...
    macos_native_host_projected_clip_items_for_category_group_kind_filter(
        category,
        group_id,
...
pub(crate) fn macos_native_host_projected_clip_items_for_category_group_kind_filter(
    category: i64,
    group_id: i64,
