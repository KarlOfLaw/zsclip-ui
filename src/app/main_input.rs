...
mod resize_hit_tests {
    ...
    #[test]
    fn border_hit_test_maps_edges_and_corners() {
        assert_eq!(main_resize_hit_test(0, 0, 400, 600, 6), Some(HTTOPLEFT as LRESULT));
        assert_eq!(main_resize_hit_test(399, 0, 400, 600, 6), Some(HTTOPRIGHT as LRESULT));
        assert_eq!(main_resize_hit_test(0, 599, 400, 600, 6), Some(HTBOTTOMLEFT as LRESULT));
        assert_eq!(main_resize_hit_test(399, 599, 400, 600, 6), Some(HTBOTTOMRIGHT as LRESULT));
        assert_eq!(main_resize_hit_test(2, 200, 400, 600, 6), Some(HTLEFT as LRESULT));
        assert_eq!(main_resize_hit_test(397, 200, 400, 600, 6), Some(HTRIGHT as LRESULT));
        assert_eq!(main_resize_hit_test(200, 2, 400, 600, 6), Some(HTTOP as LRESULT));
        assert_eq!(main_resize_hit_test(200, 597, 400, 600, 6), Some(HTBOTTOM as LRESULT));
        assert_eq!(main_resize_hit_test(200, 200, 400, 600, 6), None);
    }
}
