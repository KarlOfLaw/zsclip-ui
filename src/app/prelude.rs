...
pub(in crate::app) use crate::win_system_params::{
    ...
    IDC_SET_HOVERPREVIEW, IDC_SET_IMAGE_PREVIEW, IDC_SET_IMAGE_ZOOM_PREVIEW,
    IDC_SET_LAN_ACCEPT_PAIR, IDC_SET_LAN_COPY_PAIR,
    ...
    IDC_SET_POSMODE, IDC_SET_QUICK_DELETE, IDC_SET_RICH_TEXT, IDC_SET_SAVE, IDC_SET_SEARCH_ENGINE,
